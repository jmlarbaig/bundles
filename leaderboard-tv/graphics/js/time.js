    ...
    try{
        ...
        var $item = $(
            '<div class="heat row d-xl-flex align-items-xl-center">' +
                '<div class="col">' +
                    '<div class="row">' +
                        '<div class="col text-center div_wod" style="padding-left: 10px;color: white;padding-bottom: 1px;padding-top: 1px;">' +
                            '<div class="m-auto">'+ data.workoutName + '</div>' +
                            '<div class="row " style="padding-top:5px"> ' +
                            ' <div class="col text-center">' +
                                    '<div id="division" class="m-auto"></div>' +
                                '</div>' +
                            '</div>' +
                        '</div>' +
               ...
               ' <div class="col" style="color: rgb(255,255,255);padding-top: 5px;padding-bottom: 5px; text-align:center;font-size:50px;">' +
                    '<div class="text-center m-auto chrono" id="chrono" style="text-align:center; "></div>' +
                ' </div>' +
                '<div class="col logoPresta" >' + 
