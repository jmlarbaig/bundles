    ...
    try{
        ...
        var $item = $(
            '<div class="heat row d-xl-flex align-items-xl-center">' +
                '<div class="col text-center" style="padding-left: 10px;color: white;">' +
                    ...
                    '</div>' +
                '</div>' +
               ' <div class="col" style="color: rgb(255,255,255);padding-top: 5px;padding-bottom: 5px; text-align:center;">' +
                ...
                '<div class="col presta" >' + 
                    '<div class="text-center">' + '<h3 style="color:white;font-size:10px;"> DESIGN BY </h3><img class="logo img-fluid" src="./img/PRESTA/FV-logo.png"/> ' + '</div>' +
                '</div>' +
            '</div>' 
        );
